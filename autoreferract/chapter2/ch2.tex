...
Analysis of Figure~\ref{fig_kinematics_110511} reveals that the coronal wave was asymmetric in shape. The time-dependent evolution of the angular distance differed slightly between the left and right flanks.
